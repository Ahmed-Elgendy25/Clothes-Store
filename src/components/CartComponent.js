...
function CartComponent() {
  ...
  return (
    showModal && (
      <div className="fixed top-0 w-full right-0 h-full md:w-1/2 lg:w-1/3  bg-gray-50 shadow-md overflow-y-auto">
            ...
            {cartItems.map((product) => (
              <li key={product.id} className="flex  p-6 ">
                ...
                <div className="mx-3  w-2/6 flex flex-col items-end justify-between">
                  <div onClick={() => removeFromCart(product)} className="p-3">
                    <UilTrashAlt />
                  </div>
        ...
        <div className="  p-3 bg-white shadow-2xl shadow-black absolute w-full h-1/6  bottom-0">
